...
We recognize that survey data can come with problems in terms of its reliability (i.e. random measurement error is minimized) and validity (are the) we must recognizing that   comes with unique is close-ended and multiple choice question types to capture demographics and frequency calculations (No, Yes, Not relevant, Refused).
