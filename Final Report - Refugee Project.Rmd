...
- Refugees in age groups 16-30 and 31-45 represent the majority of the distribution. take the most count in refugee age distribution. When we factor in gender, we find that there isn't significant difference between male and female refugees.
```{r results='hide', message=FALSE, warning=FALSE}
df <- ASRraw
...
#2
b8 <- ggplot(data_filt,aes(x=age,y=count,fill=age_group))+geom_histogram(aes(y=..count..))
```
