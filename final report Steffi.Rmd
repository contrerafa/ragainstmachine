...
The policy debate in the United States is dominated by the question of how much of an economic burden refugees put on the tax system. For this reason, we created visualizations showing how many refugees in our sample have chosen to use government benefits in the past 12 months.  The visualizations show that for cash asssitance programs, few refugees receive them. For one, non-cash assistance programs have a higher income threshold. Additionally, the "i don't know" category is more pronounced than for cash asssistance programs, meaning that ... why wont this work now 
```{r}
